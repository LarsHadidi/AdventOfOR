...
w = [0,0,0,0]
w[0] = number = st.number_input("Neighbours Weight", min_value=0.0, max_value=1.0, value=.0)
w[1] = number = st.number_input("Area Weight", min_value=0.0, max_value=1.0, value=1.0)
w[2] = number = st.number_input("Long Edge Weight", min_value=0.0, max_value=1.0, value=.0)
w[3] = number = st.number_input("South Garden Weight", min_value=0.0, max_value=1.0, value=.0)
